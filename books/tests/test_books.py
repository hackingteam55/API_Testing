from books.requests.books import get_book, get_books


class TestBooks:

    # test initial - smoke testing (tip de testare facut la inceput pentru a verifica ca sistemul
    # este suficient de stabil sa suporte procesul de testare)
    ...
    # 1.a. testare pozitiva (positive testing) = tip de testare in care verificam ca sistemul accepta inputurile
    # pe care ar trebui sa le accepte
    ...
    # Test 3: Verifica requestul de get books cu filtrare pe limita - equivalence partitioning -
    # clasa de echivalenta valida
    ...
    # Test 3.3: Verifica requestul de get books cu filtrare pe limita - equivalence partitioning -
    # clasa de echivalenta invalida
    ...
    # Test 3.4: Verifica requestul de get books cu filtrare pe limita - equivalence partitioning -
    # clasa de echivalenta invalida
    ...
    # 1.b. testare negativa (negative testing) = tip de testare in care verificam comportamentul sistemului atunci cand
    # primeste inputuri pe care nu ar trebui sa le accepte
    # testam in primul rand ca inputurile sunt respinse si in al doilea rand ca mesajul de eroare si
    # codurile de raspuns sunt cele asteptate
